<?php
    ...
    try {
        $bdd = getBDD();
        $stmt = $bdd->prepare("UPDATE proprietaire SET (nom=:nom, prenom=:prenom, nombreCondu=:nombreCondu, commune=:communeCondu, quartier=:quartierCondu, telephone=:telephone) WHERE id='".$_GET["id"]."'");
