...
import '../styles/styleAdminItem.css';

export default function AdminItem({ matricule, nomComplet}){
    function versSuppr(){
        navigate("/ConfirmDeleteAdmin?matricule="+matricule);
    }
    ...
    return (
        <div style={{position:"relative"}} className="item">
            ...
            <div className='suppr' onClick={versSuppr}>
